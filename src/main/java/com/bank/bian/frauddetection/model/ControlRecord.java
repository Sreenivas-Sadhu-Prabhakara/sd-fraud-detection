package com.bank.bian.frauddetection.model;
...
/**
 * The BIAN control record for this service domain: "Fraud Alert Monitoring State".
 *
 ...
 * to its asset type (Fraud Alert). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Fraud Alert Monitoring State";
